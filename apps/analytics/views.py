...
class DashboardSummaryAPIView(APIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        data = AnalyticsService.get_dashboard_summary(date_range)
...
class LeadsAnalyticsAPIView(APIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        leads_data = AnalyticsService.get_leads_metrics(date_range)
        sources_data = AnalyticsService.get_lead_source_breakdown(date_range)
...
class BookingsAnalyticsAPIView(APIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        bookings_data = AnalyticsService.get_bookings_metrics(date_range)
...
class ServicesAnalyticsAPIView(APIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        services_data = AnalyticsService.get_popular_services(date_range, limit=limit)
